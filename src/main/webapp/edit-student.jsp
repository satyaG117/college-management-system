<%-- 
    ...
    Created on : Apr 24, 2023, 11:02:43 PM
    Author     : ROG
--%>
...
<html>
    ...
    <body>
        ...
        <%
           ...
           String query = "SELECT student_id , name  , phone_no , gender FROM student WHERE student_id = ?";
           ...
           while(rs.next()){ 
            ...
            <form class="border p-4 registration-form" action="update-student" method="post">
                <h2>Edit details</h2>
                <hr />
